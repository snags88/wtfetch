(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("wtfetch", [], factory);
	else if(typeof exports === 'object')
		exports["wtfetch"] = factory();
	else
		root["wtfetch"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.deleteRequest = exports.patch = exports.post = exports.get = undefined;
	...
	var get = exports.get = function get(url) {
	  ...
	  if (data) {
	    requestUrl = url + '?' + (0, _uriEncoder.param)(data);
	  }
	
	  var requestOptions = Object.assign({}, _defaultOptions2.default, options, { method: 'GET' });
	
	  return fetch(requestUrl, requestOptions).then(_responseHelpers.checkStatus).then(_responseHelpers.parseJSON);
	};
	...
	var post = exports.post = function post(url) {
	  ...
	  var requestOptions = Object.assign({}, _defaultOptions2.default, options, {
	    method: 'POST',
	    body: JSON.stringify(data)
	  });
	
	  return fetch(url, requestOptions).then(_responseHelpers.checkStatus).then(_responseHelpers.parseJSON);
	};
...
/***/ function(module, exports) {
	...
	var param = exports.param = function param(obj) {
	  var prefix = void 0,
	      key = void 0,
	      value = void 0,
	      r20 = /%20/g,
	  ...
	  return serialized.filter(function (k) {
	    return k !== undefined;
	  }).join('&').replace(r20, '+');
	};
	  ...
	  if (Array.isArray(obj)) {
	    for (key in obj) {
	      ...
	      if (rbracket.test(prefix)) {
	        ...
	        buildParams(prefix + "[" + ((typeof value === "undefined" ? "undefined" : _typeof(value)) === "object" && value != null ? key : "") + "]", value, add);
	      }
	    }
...
;
//# sourceMappingURL=wtfetch.js.map